...
# Data download URLs.
urls = {
    'library1.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1GVE230n_pEC5EKxF4N3MBiLWAkQhCIi1',
    'library2_pulldown.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1MB-sxRvTr347v6YWDmbCI6Wz7x-ZyS5L',
    'library2_invivo.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=18uPoZDoea7MbC67VqdXADxlcLP2mgSWN',
    'round2_codons_merged.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=11X_MA5zADkD3c8ODbeKxAj3T5REgw3SG',
    'round2_codons_separate.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=16YO5get4-gTTZp-yfI8sZHkox5qxAW_A',
    'SVAE_SM_library_references_only.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1hgtpdLK7CqAIiwpGa13KknSJTFtR0nFE',
    'SVAE_SM_library_codons_merged.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=14PTbHNhuLrykbk4z-sk30uK9eQccLicv',
    'SVAE_SM_library_codons_separate.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1o6QGtiQaie0bn7NOV65exf12hrdYhHsx',
    'LY6A_SVAE_generated_sequences.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1_whfl9rOYsTviUmZwAcYCBBiqzqOnUi3',
    'LY6C1_SVAE_generated_sequences.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=13N4UCtJf3ygT7cBnpA1W1WggdmyfVJRl',
    'LY6A_joint_umap_l1_l2.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1Zv3_zQXcAQ4T6eqNuU3HuvEmhgYjyqn0',
    'LY6C1_joint_umap_l1_l2.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1QEakj1F2nEU0XBgGPT6aoVFBCTCcMZhw',
    'LY6A_SVAE_training_predictions.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1dMxEASRC0zeEzZF6DISddvQeM6Cynd_C',
    'LY6C1_SVAE_training_predictions.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1XM2UG_DE8Y4PSTL9YAzEOCdMRsGIUWFf',
    'pulldown_assay_counts.csv': 'https://drive.google.com/uc?export=download&confirm=t&id=1VN8kET-ayVZnbdzVshDwsmYAKrjKjto1',
}
...
def download_data(filename, url):
    ...
    if not os.path.exists(filename):
        # Sometimes Google will restrict drive downloads, just prompt the user instead.
