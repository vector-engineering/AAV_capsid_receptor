...
**Note:** all figure-generation notebooks assume figure data is contained in `AAV_capsid_receptor/figures/data` (see [Data](#data) for more details).
...
### Google Drive 
All relevant data is stored in [this Google Drive folder](https://drive.google.com/drive/folders/1uNR7tMncf1x2hNXvbEbg-D0KF7mLdGNV). Once downloaded, data files should be put into `AAV_capsid_receptor/figures/data` - by default, figure-generation notebooks will search for data there.
